...
import cn.katool.security.gateway.utils.KaToolSecurityResultUtils;
import cn.katool.security.service.AuthService;
import cn.katool.security.gateway.constant.GlobalContainer;
import cn.katool.security.gateway.constant.KaToolSecurityErrorCode;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        for(GlobalContainer.Route v:GlobalContainer.authRouteList){
            ...
            if (url.equals(path.value())&&method.equals(requestMethod)){
                ...
                if(!KaToolSecurityAuthQueue.run(v.getRole())){
